...
function getWorkoutSummary($start,$end) {
...
$base_string = oauth_get_sbs('GET','https://wbsapi.withings.net/v2/measure?action=getworkouts',$userTokenParameters);
$signature = urlencode(base64_encode(hash_hmac('sha1',$base_string,$hashSecret,true)));


$url = "https://wbsapi.withings.net/v2/measure?action=getworkouts&startdateymd=$start&enddateymd=$end&oauth_consumer_key=$consumer_key&oauth_nonce=$nonce&oauth_signature=$signature&oauth_signature_method=$signature_method&oauth_timestamp=$timestamp&oauth_token=$oauth_token&oauth_version=$oauth_version";
...
print_r($resp);
	...
	getWorkoutSummary('2015-07-04','2015-09-03');
?>
