		...
		<div class="container">
			<div class="row" style="margin-top:60px;">
				<div class="col-md-8 col-md-offset-2">
					...
					<h3 class="sign-up-title" style="color: #000000;"><?php echo $title; ?></h3>
				...
				// otherwise, we take user1's
					...
					{
						?>
						<p style="color:#BBBBBB; font-size:10px;"> Sent: <?php echo $row['mytimestamp'];?> </p>
						<h6 id="user" style="color:#d23"> <?php if ($row['user1'] == $userid){
							echo $myname;
							echo "<script>
								$('#user').css('color','#d23')
							</script>";
					...
					<a name ="reply"> </a>
					<h3 name="reply" class="sign-up-title" style="color: #000000;">Reply</h3>
					<div class="center">
						<form action="read_pm.php?id=<?php echo $convoid; ?>" method="post">
							<label for="message" class="center">Message</label><br />
							<textarea cols="40" rows="5" name="message" id="message" style="width:100%;"></textarea><br />
