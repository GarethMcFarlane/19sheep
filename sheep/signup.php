				...
				<div class="row" style="margin-top:60px;">
					<div class="col-md-4 col-md-offset-4 signin-box">
						<form method="POST" action="#" accept-charset="UTF-8" role="form" id="signupform" class="form-signin text-center">
							<fieldset>
								<h3 class="sign-up-title" style="color: #000000; text-align: center">Hello! Please input your detail</h3>
								<label>Email:</label>
								...
								<input type="date" name="bday" max="2015-10-09" class="form-control" placeholder="1900-01-01">
								<label>Height:</label>
