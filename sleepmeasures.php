...
$url = "https://wbsapi.withings.net/v2/sleep?action=get&userid=$userid&startdate=1441245600&enddate=1441332000&oauth_consumer_key=$consumer_key&oauth_nonce=$nonce&oauth_signature=$signature&oauth_signature_method=$signature_method&oauth_timestamp=$timestamp&oauth_token=$oauth_token&oauth_version=$oauth_version";
