					...
					<div class="textCommit">
						<form method="POST" action="commitments.php" accept-charset="UTF-8" role="form" id="signupform" class="form-signin text-center">
							...
							<div class="dateMessage">
								<div id="halfway">You are halfway through your commitment, keep it up!</div>
								<div id="oneWeek">You have one week left on your commitment, nearly there!</div>
								<input class="submit btn btn-success" id="achieved" value="Achieved!" type="submit">
								<input class="submit btn btn-warning" id="dismiss" value="dismiss" type="reset">
							</div>
								
							
							<div class="dateMessage" id="oneWeek">
								<input class="submit btn btn-warning" value="Reset" type="reset">
